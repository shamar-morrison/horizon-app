!(function (e) {
			...
			push(data) {
				...
				window.addEventListener('message', function (event) {
					...
					'object' == typeof d &&
						...
						((d.player = player),
						d.name == self.INIT
							? iframe.contentWindow.postMessage({ id: id, name: 'init', data: JSON.parse(JSON.stringify(dd)) }, '*')
	...
	function (e, t, n) {
		...
		function r(e, t = {}) {
			for (const n of e) {
				...
				e && e.match('^magnet:.*') && (i = e),
					((e && e.match('.torrent$')) || (e && 'application/x-bittorrent' == n.getAttribute('type'))) && (r = e),
					n.getAttribute('data-torrent') && (r = n.getAttribute('data-torrent'));
				const a = n.parentNode,
					d = n.getAttribute('width'),
					u = n.getAttribute('height'),
					s = n.getAttribute('poster'),
					c = '' == n.getAttribute('controls') || 'true' == n.getAttribute('controls'),
					l = {};
				...
				n.getAttribute('class') && g.setAttribute('class', n.getAttribute('class')),
		...
		(window.webtor = Object(i.a)(window.webtor)),
			...
			r(document.querySelectorAll('a[download]'), { mode: 'download', width: '400px' });
	},
	function (e, t, n) {
		var i = n(6);
		...
		!(function (n) {
			if ('undefined' != typeof window) {
				...
				window.jQuery &&
					...
					(o = []),
					void 0 === (r = 'function' == typeof (i = J) ? i.apply(t, o) : i) || (e.exports = r),
			...
			function A(e) {
				...
				function u(e) {
					...
					M(S, 'Reposition requested from iFrame (offset x:' + t.x + ' y:' + t.y + ')'),
						window.top !== window.self
							? window.parentIFrame
								? window.parentIFrame['scrollTo' + (e ? 'Offset' : '')](n.x, n.y)
								: x(S, 'Unable to scroll to requested position, window.parentIFrame not found')
							: ((m = n), s(), M(S, '--'));
				}
				function s() {
				...
				'[iFrameResizerChild]Ready' === P
					...
					? ((w = P.substr(f).split(':')),
					  ...
					  (A = { iframe: O, id: w[0], height: _ + n(T) + i(T), width: w[2], type: w[3] }),
					  (S = A.id),
					  p[S] && (p[S].loaded = !0),
					  (b = A.type in { true: 1, false: 1, undefined: 1 }) && M(S, 'Ignoring init message from meta parent page'),
					  !b &&
							(function (e) {
								var t = !0;
							...
							(M(S, 'Received: ' + P),
							(h = !0),
							null === A.iframe && (x(S, 'IFrame (' + A.id + ') not found'), (h = !1)),
							h &&
								(function () {
									var t,
										n = e.origin,
										...
										!(i.constructor === Array
											? (function () {
													var e = 0,
														t = !1;
													for (
														M(S, 'Checking connection is from allowed list of origins: ' + i);
														e < i.length;
														e++
													)
														if (i[e] === n) {
											...
											: ((t = p[S] && p[S].remoteHost), M(S, 'Checking connection is from: ' + t), n === t))
									)
										throw new Error(
								...
								(function () {
									switch ((p[S] && p[S].firstRun && p[S] && (p[S].firstRun = !1), A.type)) {
										...
										case 'message':
											(e = r(6)),
												M(S, 'onMessage passed: {iframe: ' + A.iframe.id + ', message: ' + e + '}'),
												g('onMessage', { iframe: A.iframe, message: JSON.parse(e) }),
												M(S, '--');
											break;
										case 'autoResize':
										...
										case 'inPageLink':
											!(function (e) {
												...
												o
													? ((t = d(o)),
													  M(S, 'Moving to in page link (#' + n + ') at x: ' + t.x + ' y: ' + t.y),
													  (m = { x: t.x, y: t.y }),
													  s(),
													  M(S, '--'))
													: window.top !== window.self
													? window.parentIFrame
														...
														: M(S, 'In page link #' + n + ' not found and window.parentIFrame not found')
			...
			function W(e) {
				...
				function n(n) {
					!(function (t) {
						e.id
							? ((e.iframe.style[t] = e[t] + 'px'), M(e.id, 'IFrame (' + i + ') ' + t + ' set to ' + e[t] + 'px'))
					...
					p[i] &&
						(n && 'contentWindow' in n && null !== n.contentWindow
							? ((r = p[i] && p[i].targetOrigin),
							  M(i, '[' + e + '] Sending msg to iframe[' + i + '] (' + t + ') targetOrigin: ' + r),
			...
			function U(e, t) {
				...
				var i,
					...
					r = (function (n) {
						...
						return (
							'' === n &&
								((e.id = ((i = (t && t.id) || w.id + d++), null !== document.getElementById(i) && (i += d++), (n = i))),
								(u = (t || {}).log),
				...
				r in p && 'iFrameResizer' in e
					...
					: (!(function (t) {
							var i;
							(t = t || {}),
								(p[r] = { firstRun: !0, iframe: e, remoteHost: e.src && e.src.split('/').slice(0, 3).join('/') }),
								(function (e) {
								...
								(function (e) {
									for (var t in w)
										Object.prototype.hasOwnProperty.call(w, t) &&
											(p[r][t] = Object.prototype.hasOwnProperty.call(e, t) ? e[t] : w[t]);
								})(t),
								p[r] &&
									(p[r].targetOrigin =
										!0 === p[r].checkOrigin
											? '' === (i = p[r].remoteHost) || null !== i.match(/^(about:blank|javascript:|file:\/\/)/)
												? '*'
												: i
											: '*');
					  })(t),
					  (function () {
							switch (
								(M(r, 'IFrame scrolling ' + (p[r] && p[r].scrolling ? 'enabled' : 'disabled') + ' for ' + r),
								(e.style.overflow = !1 === (p[r] && p[r].scrolling) ? 'hidden' : 'auto'),
								p[r] && p[r].scrolling)
							) {
								case 'omit':
									break;
					  ...
					  (function () {
							function t(t) {
								1 / 0 !== p[r][t] &&
									0 !== p[r][t] &&
									((e.style[t] = p[r][t] + 'px'), M(r, 'Set ' + t + ' = ' + p[r][t] + 'px'));
							}
							function n(e) {
					  ...
					  ('number' != typeof (p[r] && p[r].bodyMargin) && '0' !== (p[r] && p[r].bodyMargin)) ||
							((p[r].bodyMarginV1 = p[r].bodyMargin), (p[r].bodyMargin = p[r].bodyMargin + 'px')),
					  (i = j(r)),
					  (o = _()) &&
							(function (t) {
								e.parentNode &&
						...
						switch (
							...
							(function (e) {
								e &&
									...
									x('enablePublicMethods option has been removed, public methods are now always available in the iFrame');
							})(n),
							typeof i)
						) {
							case 'undefined':
		...
		!(function (t) {
			if ('undefined' != typeof window) {
					...
					X =
						...
						function () {
							...
							return (
								...
								(B = arguments),
								t <= 0 || t > A
									? (q && (clearTimeout(q), (q = null)), (K = e), (H = j.apply(U, B)), q || (U = B = null))
									: q || (q = setTimeout(J, t)),
								H
							);
						});
				$(window, 'message', function (t) {
					...
					y === ('' + t.data).substr(0, _) &&
						(!1 === c ? a() : r() ? n.init() : te('Ignored message of type "' + i() + '". Received before initialization.'));
				}),
			...
			function ie() {
				...
				!(function () {
					...
					(function () {
						function e(e, t) {
							return 'function' == typeof e && (te('Setup custom ' + t + 'CalcMethod'), (F[t] = e), (e = 'custom')), e;
						}
						'iFrameResizer' in window &&
							...
							(f = 'heightCalculationMethod' in t ? t.heightCalculationMethod : f),
							(S = 'widthCalculationMethod' in t ? t.widthCalculationMethod : S),
							(f = e(f, 'height')),
							(S = e(S, 'width')));
						var t;
					...
					(C.parentIFrame = {
						autoResize: function (e) {
							return (
								!0 === e && !1 === n
									? ((n = !0), le())
									: !1 === e && !0 === n && ((n = !1), de('remove'), null !== a && a.disconnect(), clearInterval(b)),
					...
					(h = (function () {
						...
						function t(t) {
							...
							void 0 !== o
								? (function (t) {
										var i = e(t);
										te('Moving to in page link (#' + n + ') at x: ' + i.x + ' y: ' + i.y),
											Oe(i.y, i.x, 'scrollToOffset');
								  })(o)
								: (te('In page link (#' + n + ') not found in iFrame, so sending to parent'),
								  Oe(0, 0, 'inPageLink', '#' + n));
						}
						function n() {
						...
						h.enable
							? Array.prototype.forEach && document.querySelectorAll
								? (te('Setting up location.hash handlers'),
								  ...
								  $(window, 'hashchange', n),
								  setTimeout(n, 128))
								: ne('In page linking not fully supported in this browser! (See README.md for IE8 workaround)')
			...
			function de(e) {
				ae({ method: e, eventType: 'Animation Start', eventNames: ['animationstart', 'webkitAnimationStart'] }),
					ae({ method: e, eventType: 'Animation Iteration', eventNames: ['animationiteration', 'webkitAnimationIteration'] }),
					ae({ method: e, eventType: 'Animation End', eventNames: ['animationend', 'webkitAnimationEnd'] }),
					...
					ae({ method: e, eventType: 'Orientation Change', eventName: 'orientationchange' }),
					ae({ method: e, eventType: 'Print', eventName: ['afterprint', 'beforeprint'] }),
					ae({ method: e, eventType: 'Ready State Change', eventName: 'readystatechange' }),
					ae({ method: e, eventType: 'Touch Start', eventName: 'touchstart' }),
					ae({ method: e, eventType: 'Touch End', eventName: 'touchend' }),
					ae({ method: e, eventType: 'Touch Cancel', eventName: 'touchcancel' }),
					ae({
						method: e,
			...
			function ue(e, t, n, i) {
				return (
					t !== e &&
						(e in n || (ne(e + ' is not a valid option for ' + i + 'CalculationMethod.'), (e = t)),
			...
			function ge(e, t) {
				for (var n = t.length, i = 0, o = 0, r = Z(e), a = V(), d = 0; d < n; d++)
					(i = t[d].getBoundingClientRect()[e] + me('margin' + r, t[d])) > o && (o = i);
				return (
					(a = V() - a),
			...
			function pe(e, t) {
				...
				return (
					0 === n.length && (ne('No tagged elements (' + t + ') found on page'), document.querySelectorAll('body *')), ge(e, n)
				);
			}
			function be() {
			...
			function we(e, t, n, i) {
				...
				!(function () {
					...
					return (o = void 0 !== n ? n : Y[f]()), (r = void 0 !== i ? i : Q[S]()), e(l, o) || (u && e(R, r));
				})() && 'init' !== e
					? !(e in { init: 1, interval: 1, size: 1 }) && (f in E || (u && S in E))
						? Ee(t)
			...
			function ye(e, t, n, i) {
				x && e in s
					...
					: (e in { reset: 1, resetPage: 1, init: 1 } || te('Trigger event: ' + t),
			...
			function Oe(e, t, n, i, o) {
				...
				void 0 === o ? (o = M) : te('Message targetOrigin: ' + o),
					te('Sending message to host page (' + (r = v + ':' + e + ':' + t + ':' + n + (void 0 !== i ? ':' + i : '')) + ')'),
					T.postMessage(y + r, o);
			}
			function Te() {
